...
uint8_t HID_UploadNextPacket(void);   /* 上传一包采集数据，返回 1=还有，0=完成 */
void    HID_UploadReset(void);        /* 复位上传状态 */
uint8_t HID_RelayResponse(uint8_t *pData, uint16_t len);  /* 中转回传磁编响应到上位机 */
